# Documentação do Campus Backend

Esta pasta concentra decisões de produto, arquitetura e experiência. O `README.md` da raiz apresenta o projeto; os documentos daqui registram detalhes para manutenção e evolução.
